...
//
// 7. forEach — метод масиву, викликає функцію для кожного елемента масиву
// let arr = [10, 20, 30];
...
// // Елемент: 30 Індекс: 2
//
// 4. for...in — перебирає всі ключі (властивості) об'єкта
// let obj = {a: 1, b: 2, c: 3};
// for (let key in obj) {
...
// // Ключ: c Значення: 3
//
// 5. for...of — перебирає значення ітерабельних об'єктів (масиви, рядки, тощо)
// let nums = [5, 10, 15];
